...
int main(int argc, char* argv[])
{
	...
	if(dark < 0)
	{
		printf("Please enter a DARK value greater or equals to 0.\n");
	...
	{
		system("clear");
		displayMapDark(mapRow, mapCol, map, dark, table);
...
void displayMapDark(int mapRow, int mapCol, char**map, int dark, int** table)
{
	...
	playerRow = table[0][0];
	playerCol = table[0][1];
	startRow = playerRow - dark;
	startCol = playerCol - dark;
	endRow = playerRow + dark;
	endCol = playerCol + dark;
